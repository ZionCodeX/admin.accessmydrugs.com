...
<html lang="en">
  ...
  <head>
    ...
    <title>@yield('title') | Spreadit Procurement </title>
    ...
    <!--begin::Fonts-->
		...
		<!--end::Layout Themes-->
		<link rel="shortcut icon" href="{!! url('assets2/media/logos/spreadit-logo.png'); !!}" />
	</head>
	<!--end::Head-->
					...
					<div class="login-form text-center p-7 position-relative overflow-hidden">
						...
						<div class="d-flex flex-center mb-15">
							<a href="{{ route('dashboard'); }}">
								<img src="{!! url('assets/media/logos/spreadit-logo3.png'); !!}" class="max-h-75px" alt="" />
							</a>
						</div>
						<!--end::Login Header-->
          ...
          >
                <div class="text-dark-50 font-size-lg font-weight-bolder mr-10">
                  <span class="mr-1">2021 ©</span>
                      <a
                        href="http://www.spreaditglobal.com"
                        target="_blank"
                        class="text-dark-75 text-hover-primary"
                        >Spreadit Limited</a
                      >
                </div>
                <a href="https://www.spreaditglobal.com/terms" class="text-primary font-weight-bolder font-size-lg"
                  >Terms & Conditions</a
                >
          </div>
      <!--end::Content footer-->
