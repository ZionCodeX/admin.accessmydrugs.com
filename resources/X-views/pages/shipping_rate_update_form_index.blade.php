...
@section('title', 'Shipping Rate Update')
...
<!--##### XIS STANDARD FORM #####-->
<form method="post" action="{{ route('shipping_rate_update_form_prox') }}"  enctype="multipart/form-data">
    @csrf

<input type="hidden" name="pid_shipping_rate" value="{{ $shipping_rate->pid_shipping_rate }}" >
...
@component('form.select')
    ...
    @slot('required') required @endslot
        @slot('options')
            ...
            <option value="{{ $shipping_rate->country_source_name ?? '' }}" selected>{{ $shipping_rate->country_source_name ?? '' }}</option>
        @endslot
@endcomponent
...
@component('form.select')
    ...
    @slot('required') required @endslot
        @slot('options')
            @include('components.inc_country_list') 
            <option value="{{ $shipping_rate->country_destination_name ?? '' }}" selected>{{ $shipping_rate->country_destination_name ?? '' }}</option>
        @endslot
@endcomponent
...
@component('form.select')
    ...
    @slot('required') required @endslot
        @slot('options')
            <option value="{{ $shipping_rate->country_destination_currency ?? '' }}" selected>{{ $shipping_rate->country_destination_currency ?? '' }} ({{ $shipping_rate->country_destination_currency ?? '' }})</option>
...
@component('form.number')
    ...
    @slot('value') {{ $shipping_rate->shipping_rate_kg ?? '' }} @endslot
...
@component('form.number')
    ...
    @slot('value') {{ $shipping_rate->shipping_rate_cbm ?? '' }} @endslot
...
@component('form.text')
    ...
    @slot('label') Shipping Duration (Optional) @endslot
    @slot('value') {{ $shipping_rate->shipping_duration ?? '' }} @endslot
...
@component('form.textarea')
    ...
    @slot('value') {{ $shipping_rate->shipping_info ?? '' }} @endslot
    @slot('placeholder') Any additional information? @endslot
    @slot('hint') Any Additional Information, but this is optional @endslot
...
@component('form.button')
    ...
    @slot('label') Update Shipping Rate @endslot
