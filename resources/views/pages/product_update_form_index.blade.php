    ...
    <div class="card card-custom card-sticky" id="kt_page_sticky_card">
        <div class="card-header" style="">
          ...
          <div class="card-title">
            <h3 class="card-label">Update Drug / Product
            <i class="mr-2"></i>
...
<!--##### XIS STANDARD FORM #####-->
<form method="post" action="{{ route('product_update_form_prox'); }}"  enctype="multipart/form-data">
    @csrf
...
@component('form.text')
    ...
    @slot('value') {{ $product->product_price ?? '' }} @endslot
...
@component('form.text')
    ...
    @slot('value'){{ $product->product_price_old ?? '' }}@endslot
...
@component('form.text')
    ...
    @slot('value'){{ $product->product_price_wholesale ?? '' }}@endslot
...
@component('form.textarea')
    ...
    @slot('value') {{ $product->product_description ?? '' }} @endslot
...
@component('form.date')
    ...
    @slot('value'){{ $product->expiry_date ?? '' }} @endslot
...
@component('form.textarea')
    ...
    @slot('value') {{ $product->product_summary ?? '' }} @endslot
...
@component('form.textarea')
    ...
    @slot('value') {{ $product->product_tags ?? '' }} @endslot
    @slot('placeholder') Enter Product Tags for SEO Optimization here separated by commas @endslot
...
@component('form.text')
    ...
    @slot('value') {{ $product->product_quantity ?? '' }} @endslot
...
@component('form.text')
    ...
    @slot('value') {{ $product->procurement_cost ?? '' }} @endslot
...
@component('form.text')
    ...
    @slot('value') {{ $product->shipping_cost ?? '' }} @endslot
...
@component('form.text')
    ...
    @slot('value') {{ $product->tax ?? '' }} @endslot
    ...
    @slot('id') product_image @endslot
        @slot('label') 
            ...
            {{-- IMAGE BOX STARTS --}}
                ...
                @else
                <img src = '{{ URL::asset('storage/app/product_image') }}/{{ $product->product_image }}?r=@php echo(rand()); @endphp")' height="55px">
                @endif
            {{-- IMAGE BOX ENDS --}}
        @endslot
...
@component('form.checkbox')
    ...
    @slot('value') {{ $product->shipping_status ?? '' }} @endslot
...
@component('form.button')
    ...
    @slot('label') Update Product in Store @endslot
