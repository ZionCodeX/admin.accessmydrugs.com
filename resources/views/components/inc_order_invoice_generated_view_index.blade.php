    ...
    <div class="card card-custom card-sticky" id="kt_page_sticky_card">
      <div class="card-header" style="">
        <div class="card-title">
          <h3 class="card-label"><b>INVOICE</b> | &nbsp; <small style="color: black;">@php $order_statusx = str_replace('_', ' ', $order_status);  echo Str::upper($order_statusx); @endphp </small>
          <i class="mr-2"></i>
...
<div class="card">
  ...
  <div class="card-body">
    ...
    <div class="form-group mb-0">
        @include("components.inc_invoices")
    </div>
